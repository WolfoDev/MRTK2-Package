...
namespace Microsoft.MixedReality.Toolkit.Teleport
{
    ...
    public class TeleportPointer : LinePointer, IMixedRealityTeleportPointer, IMixedRealityTeleportHandler
    {
        ...
        protected LayerMask ValidLayers = UnityPhysics.AllLayers;//HACK chagned from default to all layers
        ...
        {
            base.Start();
            ValidLayers = UnityPhysics.AllLayers;//HACK chagned from default to all layers
